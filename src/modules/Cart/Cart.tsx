...
import BreadcrumbCart from "./partials/BreadcrumbCart";
...
const CartPage = () => {
    ...
    items: [
      {
        ...
        attributes: ["M", "Black"],
        discount: { amount: 0, type: "fixed", percentage: 0 },
      },
      {
        id: 2,
        name: "Product Name 2",
  ...
  const adjustedTotalPrice = totalPrice; // Adjust this according to your discount logic
      ...
      <div className="max-w-7xl mx-auto px-4 xl:px-0">
        {cart && cart.items.length > 0 ? (
          ...
          <div className="flex items-center flex-col text-gray-300 mt-32">
            <ShoppingCart strokeWidth={1} className="text-6xl" />

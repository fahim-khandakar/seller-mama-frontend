...
import { User, Mail, Lock, Phone, MapPin, Image as IconImage, Shield } from 'lucide-react';
      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle className="text-2xl font-black uppercase tracking-tighter text-slate-900 dark:text-white">
            Create <span className="text-orange-600">User</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2 ml-1">
                <IconImage className="w-3 h-3 text-orange-600" aria-hidden="true" />
                <Label className="text-[10px] font-black uppercase text-slate-500 tracking-widest">
                  Picture URL
                </Label>
              </div>
